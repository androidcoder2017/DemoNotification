package com.example.a15056112.demonotification;
        ...
        btnNotify2 = (Button)findViewById(R.id.btnNotify2);
         ...
         btnNotify1.setOnClickListener(new View.OnClickListener() {
             ...
             public void onClick(View v) {
                ...
                // using the current default notification ringtone to add sound to the notification
                 Uri uri = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION);
                 builder.setSound(uri);

                 //Building Heads-up Notification which is a Notification to grab a user’s attention
